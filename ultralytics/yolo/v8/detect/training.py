...
import pytz
import psycopg2
from psycopg2 import Error  # Import Error from psycopg2
    ...
    for i, box in enumerate(bbox):
        ...
        if len(data_deque[id]) >= 2:
            ...
            if intersect(data_deque[id][0], data_deque[id][1], line[0], line[1]):
                ...
                object_counts = {'car': 0, 'bus': 0, 'truck': 0, 'person': 0, 'motorbike': 0, 'bicycle': 0,
                                 'traffic light': 0}
                ...
                try:
                    ...
                    insert_query = """INSERT INTO accounts_vehicleanalysis (customer_id, cam_id, image_id, date, week_day, time, out_time,
                                                        car, bus, truck, motorbike, human, cycle, generic, store_number, store_name, ownership_type,
                                                        street_address, city, state, country, timezone, longitude, latitude)
